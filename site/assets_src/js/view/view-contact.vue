/**
* -----------------------------------------------------
* Created by uforgot on 2017. 8. 24.
* zanybros
* -----------------------------------------------------
*/
...
<script>
    ...
    export default {
        ...
        created:function(){
            this.dataPrevContents = Window.ZanyBrosData.data.contentsData[1];
            this.dataNextContents = Window.ZanyBrosData.data.contentsData[0];
